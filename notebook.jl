...
# ╔═╡ 5ad3d35c-88a3-11ec-3f16-19b48dc23f08
using HTTP, CSV, DataFrames, PyCall, DataFramesMeta

# ╔═╡ c6164e87-7dc4-4ac0-b442-867a92d07ea9
...
# ╔═╡ 41f823e6-d54f-4d45-bca0-873f99378720
"""
...
# ╔═╡ 6700cfd2-a34f-4cd3-a1e7-7a98ae4bfd9f
?get_data

# ╔═╡ 842dfc55-0daa-4fa6-9ba5-87b40db7dbc8
begin
try
...
# ╔═╡ e929d73a-33b6-4edc-b073-bcdf563abb6d
py"""
foo = [1]
foo = foo + ['a', 'b']
foo
...
# ╔═╡ e7153af1-28dd-4bf8-90e9-603ad37e9bd3
foo = Any[1] # need to set to Any or it'll assume it's an Integer and it'll fail on the two strings there


# ╔═╡ cc5a42b7-ad58-49e3-b738-a199f5e32f91
append!(foo, ["a"])

# ╔═╡ cabb8e0b-340b-4705-b767-e9eaf03d375c
begin
	bar = foo |> copy
	append!(bar, ["b"])
end

# ╔═╡ 29a08fac-74d3-44f3-acd0-ec427d01c405
foo == bar  

# ╔═╡ d8cc8b55-9231-498d-a8c9-abdabe94f4ec
first(df, 5)
